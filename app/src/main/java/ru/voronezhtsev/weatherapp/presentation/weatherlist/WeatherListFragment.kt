...
class WeatherListFragment : Fragment() {
    ...
    private lateinit var listener: OnWeatherClickListener
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        weatherAdapter = WeatherAdapter(emptyList<WeatherModel>().toMutableList(),
                View.OnClickListener { viewModel.loadWeather(getCityId((it.tag as AppCompatTextView).text.toString())) },
                View.OnClickListener { listener.onWeatherClick(it.tag.toString()) })
    ...
    interface OnWeatherClickListener {
        fun onWeatherClick(cityName: String)
    }
}
